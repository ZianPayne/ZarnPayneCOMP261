...
public class CustomTests {
     ...
     * Helper method to test Articulation points
     */
    public static void testArticulationPoints2() {
        ...
        Stop g = new Stop(0, 0, "G", "G");
        Stop h = new Stop(0, 0, "H", "H");
        Stop i = new Stop(0, 0, "I", "I");
        Stop j = new Stop(0, 0, "J", "J");
        Stop k = new Stop(0, 0, "K", "K");
        Stop l = new Stop(0, 0, "L", "L");
        Stop m = new Stop(0, 0, "M", "M");
        Stop n = new Stop(0, 0, "N", "N");
        Stop o = new Stop(0, 0, "O", "O");
        Stop p = new Stop(0, 0, "P", "P");
        ...
        List<Stop> testStops = List.of(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p);
        List<Line> emptyLineList = new ArrayList<>();
        Graph testGraph = new Graph(testStops, emptyLineList);
        ...
        boolean testPassed = ourResult.contains(i) && ourResult.contains(e) && ourResult.contains(g);

        System.out.println("\n===========================================");
        System.out.println("Test Articulation Algorithm Test #2!");
        if(testPassed) { System.out.println("Your test articulation algorithm works! (on a basic example at least) :)"); }
        else {
            System.out.println("Your test articulations algorithm fails :(");
            System.out.println("Expected output: " + correctResult);
    ...
    public static void main(String[] args) {
        ...
        CustomTests.testArticulationPoints2();
    }
}
